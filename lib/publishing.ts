...
function mapBusiness(row: Record<string, unknown>): BusinessRecord {
  return {
    ...
    domainProvider: ((row.domain_provider as BusinessRecord["domainProvider"]) ?? "manual"),
    domainProviderStatus: ((row.provider_status as BusinessRecord["domainProviderStatus"]) ?? "manual"),
    ...
    dnsStatus: ((row.dns_status as BusinessRecord["dnsStatus"]) ?? "pending"),
    sslStatus: (row.ssl_status as BusinessRecord["sslStatus"]) ?? "pending",
    appStatus: ((row.app_status as BusinessRecord["appStatus"]) ?? "pending"),
