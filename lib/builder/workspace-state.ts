...
const PAGE_BLUEPRINTS: PageBlueprint[] = [
  {
    ...
    seoDescriptionHint: "Havalimanı ve otel transferinde güvenilir, konforlu ve zamanında hizmet. Hemen teklif alın.",
    isSystemPage: true,
    active: true,
    containerWidth: "xl",
    backgroundMode: "soft",
    ...
    hero: {
      ...
      content: {
        ...
        subtitle: "Profesyonel şoförler, konforlu araçlar ve zamanında karşılama ile seyahatiniz güvende.",
    ...
    services: {
      ...
      content: {
        ...
        description: "Havalimanı, otel ve şehir içi transferlerde konforlu ve güvenli hizmet sunuyoruz.",
  ...
  },
  {
    ...
    seoDescriptionHint: "Havalimanı, otel ve şehir içi transfer hizmetlerimizi inceleyin, hemen teklif alın.",
    isSystemPage: true,
    active: true,
    containerWidth: "lg",
    ...
    hero: {
      ...
      content: {
        eyebrow: "Hizmetlerimiz",
        title: "Size özel transfer hizmetleri",
        subtitle: "Havalimanı, otel ve şehir içi transferlerde güvenilir ve konforlu seçenekler sunuyoruz.",
        primaryButtonText: "Teklif Al",
        primaryButtonHref: "/quote",
        secondaryButtonText: "İletişim",
        secondaryButtonHref: "/contact",
    ...
    services: {
      variant: "grid",
      content: {
        eyebrow: "Hizmet Seçenekleri",
        title: "İhtiyacınıza en uygun paketi seçin",
        description: "Tüm hizmetlerimiz deneyimli şoförler ve konforlu araçlarla sunulur.",
        emptyStateTitle: "Hizmet yok",
        emptyStateDescription: "Bu işletme için henüz hizmet kaydı girilmedi.",
        maxItems: 6,
      },
    ...
    cta: {
      ...
      content: {
        ...
        description: "Ekibimiz size en kısa sürede dönüş yapar.",
  ...
  },
  {
    ...
    seoTitleHint: "{business} | Araç Filomuz",
    seoDescriptionHint: "Konforlu ve güvenli araç seçeneklerimizi inceleyin, yolculuğunuza en uygun aracı seçin.",
    isSystemPage: true,
    active: true,
    containerWidth: "lg",
    backgroundMode: "light",
    ...
    hero: {
      ...
      content: {
        ...
        title: "Konforlu ve güvenli araç seçenekleri",
        subtitle: "Her yolculuk için uygun kapasite ve konforda araçlarımızla hizmetinizdeyiz.",
    ...
    services: {
      variant: "grid",
      content: {
        eyebrow: "Araç Seçenekleri",
        title: "Filomuzdaki araçları inceleyin",
        description: "Konfor ve kapasiteye göre size en uygun aracı seçin.",
    ...
    cta: {
      variant: "centered",
      content: {
        title: "Size uygun aracı birlikte belirleyelim",
        description: "Yolcu sayınızı ve güzergahınızı paylaşın, en uygun aracı önerelim.",
        primaryButtonText: "Teklif Al",
        primaryButtonHref: "/quote",
      },
      style: { tone: "brand" },
  ...
  },
  {
    ...
    seoTitleHint: "{business} | Popüler Rotalar",
    seoDescriptionHint: "Sık tercih edilen transfer güzergahlarımızı ve fiyatlarını inceleyin.",
    isSystemPage: true,
    active: true,
    containerWidth: "lg",
    backgroundMode: "light",
    ...
    hero: {
      ...
      content: {
        ...
        title: "Sık tercih edilen transfer güzergahları",
        subtitle: "Varış noktanıza göre süre ve mesafe bilgisiyle net bir seçim yapın.",
        primaryButtonText: "Teklif Al",
        primaryButtonHref: "/quote",
        secondaryButtonText: "İletişim",
        secondaryButtonHref: "/contact",
    ...
    services: {
      variant: "grid",
      content: {
        eyebrow: "Rota Seçenekleri",
        title: "Güzergahınızı seçin, teklif alın",
        description: "En çok tercih edilen rotalarımızı ve tahmini transfer sürelerini inceleyin.",
    ...
    cta: {
      variant: "centered",
      content: {
        title: "Güzergahınız listede yok mu?",
        description: "Bize ulaşın, size özel rota ve fiyat teklifi hazırlayalım.",
        primaryButtonText: "Teklif Al",
        primaryButtonHref: "/quote",
      },
      style: { tone: "surface" },
  ...
  },
  {
    ...
    seoDescriptionHint: "Seyahat ve transfer hakkında güncel yazılarımızı okuyun.",
    isSystemPage: true,
    active: true,
    containerWidth: "lg",
    backgroundMode: "light",
    ...
    hero: {
      ...
      content: {
        eyebrow: "Blog",
        title: "Seyahat ve transfer rehberi",
        subtitle: "Yolculuğunuza değer katacak ipuçları ve güncel bilgiler.",
        primaryButtonText: "Teklif Al",
        primaryButtonHref: "/quote",
        secondaryButtonText: "İletişim",
        secondaryButtonHref: "/contact",
    ...
    services: {
      ...
      content: {
        eyebrow: "Son Yazılar",
        title: "Güncel içeriklerimizi keşfedin",
        description: "Transfer ve seyahat deneyiminizi kolaylaştıracak yazılarımızı okuyun.",
        emptyStateTitle: "Yazı yok",
        emptyStateDescription: "Bu işletme için henüz blog yazısı girilmedi.",
        maxItems: 3,
      },
      style: { columns: 3 },
    },
    cta: {
      ...
      content: {
        ...
        description: "Ekibimizle iletişime geçin, size yardımcı olalım.",
        primaryButtonText: "İletişime Geç",
        primaryButtonHref: "/contact",
      },
      style: { tone: "brand" },
  ...
  },
  {
    ...
    seoTitleHint: "{business} | İletişim",
    seoDescriptionHint: "Sorularınız ve teklif talepleriniz için bize ulaşın.",
    isSystemPage: true,
    active: true,
    containerWidth: "lg",
    backgroundMode: "light",
    ...
    hero: {
      ...
      content: {
        eyebrow: "İletişim",
        title: "Bize ulaşın",
        subtitle: "Sorularınız ve teklif talepleriniz için ekibimiz size yardımcı olmaktan mutluluk duyar.",
    ...
    services: {
      ...
      content: {
        ...
        title: "Size en uygun iletişim yolunu seçin",
        description: "Telefon, e-posta veya teklif formuyla bize kolayca ulaşabilirsiniz.",
        emptyStateTitle: "Bağlantı yok",
        emptyStateDescription: "Bu işletme için henüz hızlı erişim kartı girilmedi.",
        maxItems: 4,
      },
      style: { columns: 2 },
    },
    cta: {
      ...
      content: {
        ...
        description: "Uçuş veya seyahat bilgilerinizi paylaşın, size özel fiyat sunalım.",
        primaryButtonText: "Teklif Al",
        primaryButtonHref: "/quote",
      },
      style: { tone: "surface" },
